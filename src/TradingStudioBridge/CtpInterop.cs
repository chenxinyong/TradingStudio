...
namespace TradingStudio.Ctp
{
    ...
    public static class CtpInterop
    {
        ...
        [DllImport("TradingStudioCtpBridge", CallingConvention=CallingConvention.Cdecl)]
        public static extern int CtpMd_Connect(IntPtr h, string fa);
        [DllImport("TradingStudioCtpBridge", CallingConvention=CallingConvention.Cdecl)]
        public static extern int CtpMd_Login(IntPtr h, string b, string u, string p);
        [DllImport("TradingStudioCtpBridge", CallingConvention=CallingConvention.Cdecl)]
        public static extern int CtpMd_Subscribe(IntPtr h, string[] ss, int n);
        [DllImport("TradingStudioCtpBridge", CallingConvention=CallingConvention.Cdecl)]
        public static extern int CtpMd_Unsubscribe(IntPtr h, string[] ss, int n);
        [DllImport("TradingStudioCtpBridge", CallingConvention=CallingConvention.Cdecl)]
