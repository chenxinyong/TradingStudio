...
```
K 线主图:  OxyPlot
绩效面板:  LiveCharts2 (净值曲线、回撤图、月度收益柱状图)
数据表格:  HandyControl DataGrid
```
...
> **下一步：** Phase 2a 初期，搭建 OxyPlot + FancyCandles 双方案 Demo，完成五项技术验证。OxyPlot 通过即主力推进；不通过则切 FancyCandles。
>
> **相关文档：**
> - [Phase 2 回测系统设计 v2.1](phase2-backtest-design-v2.md) — 引擎/UI 分离架构（§15）
> - [TradingStudio 架构设计精简版](TradingStudio架构设计-精简版.md) — 5 项目结构
