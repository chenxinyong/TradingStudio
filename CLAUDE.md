...
└── test/
    ...
    ├── TradingStudio.Engine.Tests/ 142 tests — 引擎(端到端黄金验证), 风控/撮合(涨跌停/滑点/爆仓/购买力), Portfolio
    ├── TradingStudio.Strategy.Tests/ 14 tests — 缠论 包含/分型/笔/中枢
    ├── ChanLunTest/                手动 demo (Program.cs，非自动化，不计入 216)
...
- 合并前确保测试全绿（当前：216/216 — Core 44 + Data 16 + Engine 142 + Strategy 14）
