...
[![Tests](https://img.shields.io/badge/tests-280%20passed-brightgreen)](test/)
...
# 运行测试（280 通过，需逐项目跑 — 一次传多个 csproj 会被 MSBuild 拒绝）
...
│   ├── TradingStudio.Engine.Tests/  引擎/端到端黄金/每日盯市/基准回测/风控/爆仓/购买力/事件持久化/Live模式（150 通过）
